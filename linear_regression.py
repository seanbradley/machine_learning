...
An example of supervised machine learning to forecast stock prices...

See scikit-learn docs re. the advantages of threaded / parallel 
algorithms (N jobs).

Similar to y = mX + b in Euclidean geometry. 

The equation of any straight line, called a linear equation, can be written 
with the above formula, where m is the slope of the line and b is the 
y-intercept. The y-intercept of this line is the value of y at the point 
